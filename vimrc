...
" fzf installed by git. see: https://github.com/junegunn/fzf/blob/master/README-VIM.md
Plug '~/.fzf'
...
" colorscheme settings | 配色方案设置
set t_Co=256   " This is may or may not needed.
set background=dark
colorscheme PaperColor

" status bar settings | 状态栏设置
